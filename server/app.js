...
const shirtTypeRoutes      = require('./modules/shirt-type/shirttype.routes');
const paymentMethodRoutes  = require('./modules/payment-method/paymentmethod.routes');
...
app.use('/api/shirt-types',       shirtTypeRoutes);
